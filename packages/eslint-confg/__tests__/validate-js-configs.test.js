...
describe('Validate JS configs', () => {
  it('Validate format-demo-eslint-config', async () => {
  ...
  it('Validate format-demo-eslint-config/es5', async () => {
  ...
  it('Validate format-demo-eslint-config/vue', async () => {
  ...
  it('Validate format-demo-eslint-config/essential', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/es5', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/react', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/vue', async () => {
  ...
  it('Validate format-demo-eslint-config/node', async () => {
