...
describe('Validate TS configs', () => {
  it('Validate format-demo-eslint-config/typescript', async () => {
  ...
  it('Validate format-demo-eslint-config/typescript/vue', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/typescript', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate format-demo-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate format-demo-eslint-config/typescript/node', async () => {
